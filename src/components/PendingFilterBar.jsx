    ...
    <div className="flex items-center gap-3 mb-6">
      <div className="relative flex-1 max-w-sm">
        ...
        <input
          ...
          placeholder="Search specific ticket"
        />
      </div>

      <CustomDropdown options={['All Channels', 'Phone', 'Mail', 'Chat']} defaultValue="All Channels" />
      <CustomDropdown options={['All Categories', 'Refund', 'Info', 'Status']} defaultValue="All Categories" />
      <CustomDropdown options={['All Dispositions', 'Resolved', 'Pending', 'Escalated']} defaultValue="All Dispositions" />
