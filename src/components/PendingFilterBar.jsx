...
const PendingFilterBar = ({ onFilterChange }) => {
  ...
  return (
    <div className="flex items-center gap-3 mb-6">
      ...
      />
      <CustomDropdown 
        options={['All Dispositions', 'Resolved', 'Pending', 'Escalated']} 
        defaultValue="All Dispositions" 
        onChange={(val) => onFilterChange('disposition', val)}
      />
