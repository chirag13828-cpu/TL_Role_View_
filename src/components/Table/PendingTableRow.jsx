...
const PendingTableRow = ({ ticket, index }) => {
  ...
  return (
    <div className="grid grid-cols-[1.2fr_1.8fr_0.8fr_1fr_1.5fr_1.2fr_1.2fr_0.8fr_1.2fr] gap-4 px-6 border-b border-gray-100 items-center text-[13px] bg-white hover:bg-[#ebf5ff] transition-colors duration-200 cursor-pointer h-[36px] overflow-visible whitespace-nowrap">
      ...
      <div className="shrink-0 flex justify-start leading-none"><DispositionBadge type={ticket.disposition} /></div>
      <div className="text-gray-800 text-left leading-none shrink-0 whitespace-nowrap">{ticket.wait}</div>
