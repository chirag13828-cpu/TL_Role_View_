...
const CompletedTableRow = ({ ticket, index }) => {
  ...
  return (
    <div className="grid grid-cols-[1.2fr_2fr_0.8fr_1fr_1.5fr_1.2fr_1.2fr_1fr] gap-4 px-6 border-b border-gray-100 items-center text-[13px] bg-white hover:bg-[#ebf5ff] transition-colors duration-200 cursor-pointer h-[36px] overflow-visible">
      ...
      <div className="text-gray-600 text-xs text-left leading-none">{ticket.resolvedOn}</div>
      <div className="text-gray-800 text-xs text-left leading-none">{ticket.trt}</div>
    </div>
  );
};
