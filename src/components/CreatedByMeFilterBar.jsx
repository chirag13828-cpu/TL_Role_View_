...
const CreatedByMeFilterBar = () => {
  ...
  return (
    <div className="flex items-center gap-3 mb-6">
      ...
      <CustomDropdown options={['All Status', 'In Progress', 'Completed', 'Unassigned']} defaultValue="All Status" />
...
export default CreatedByMeFilterBar;
